...
%feature("docstring") gr::liblte::pbch_ue "<+description of block+>"

%feature("docstring") gr::liblte::pbch_ue::make "Return a shared_ptr to a new instance of liblte::pbch_ue.

To avoid accidental use of raw pointers, liblte::pbch_ue's constructor is in a private implementation class. liblte::pbch_ue::make is the public interface for creating new instances.
